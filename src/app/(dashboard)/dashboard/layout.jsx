...
const layout = ({children}) => {
    ...
    return (
        <UserRoute>
            <div className='flex '>
                <div className="p-2 border-r border-r-indigo-950 px-5 bg-[#0f0617] flex flex-col items- justify-between">
                    <div className="flex flex-col items- mt-0">
                        <h1 className="text-xl mx-6 font- text-white font-semibold my-4 rounded border-t-2 border-r-2 border-t-indigo-500 border-r-indigo-500 
                            w-max p-1 px-4 font-oswald bg-gradient-to-tr to-indigo-900/80 from-[#3d64a2]/80 ">Inventory</h1>
                        <Link className='flex shadow-2xl gap-3 text-slate-300 py-2 px- items-center' href="/dashboard"><MdOutlineDashboard/> Dashboard</Link>
                        <Link className='flex shadow-2xl gap-3 text-slate-300 py-2 px- items-center' href="/dashboard/add-product"><MdAddToPhotos/> Add Product</Link>
                        <Link className='flex shadow-2xl gap-3 text-slate-300 py-2 px- items-center' href="/dashboard/add-product"><MdManageAccounts /> Manage Users</Link>
                    </div>
                    <div className="">
